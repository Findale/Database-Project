...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Schwan's | Suppliers</title>
				...
				<div class="container clearfix">
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="suppList.php"><i class="icon-clipboard-list i-alt"></i></a>
							</div>
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="addSupp.php"><i class="icon-file-add i-alt"></i></a>
							</div>
				...
				<div class="section">
					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="heading-block center">
							<h2>Orders by Suppliers</h2>
							<span>Suppliers with pending orders.</span>
						</div>
