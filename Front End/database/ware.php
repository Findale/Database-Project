				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" class="style-4">
						<ul>
							...
							<li class="current"><a href="#"><div>Warehouses</div></a>
								<ul>
				...
				<div class="container clearfix">
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="wareList.php"><i class="icon-clipboard-list i-alt"></i></a>
							</div>
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="empList.php"><i class="icon-users1 i-alt"></i></a>
							</div>
							<h3>Warehouse Employees</h3>
						</div>
					</div>
					...
					<div class="col_one_third col_last">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="addEmp.php"><i class="icon-file-settings i-alt"></i></a>
							</div>
