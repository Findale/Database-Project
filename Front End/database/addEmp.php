...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Schwan's | Transfer Employee</title>
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" class="style-4">
						<ul>
							...
							<li class="current"><a href="ware.php"><div>Warehouses</div></a>
								<ul>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="ware.php">Warehouses</a></li>
					<li class="breadcrumb-item active" aria-current="page">Transfer Employee</li>
				</ol>
			</div>
						...
						<div class="col-lg-7 col-md-10">
							<div class="card shadow-sm">
								<div class="card-header">
									<h4 class="mb-0">Transfer Employee</h4>
								</div>
								<div class="card-body">
									...
									<div class="form-widget">
										...
										<form class="nobottommargin" id="template-contactform" name="template-contactform" method="post" enctype="multipart/form-data">
...
<?php													$host        = "host = 127.0.0.1";
														...
														$db = pg_connect( "$host $port $dbname $credentials"  );
														$sql ="SELECT e.Employee_ID, e.F_Name || ' ' || e.M_Init || ' ' || e.L_Name as name
															from (employee e INNER JOIN works_ware w ON e.Employee_ID = w.Employee_ID
															AND w.End_Date IS NULL) ORDER BY e.F_Name";
														$ret = pg_query($db, $sql);
														if(!$ret) {
...
?>													</select>
												...
												<div class="col-12">
													<button type="submit" name="template-contactform-submit" class="btn btn-secondary btn-block btn-lg">Transfer</button>
												</div>
