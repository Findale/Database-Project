...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Schwan's | Warehouse Listing</title>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Warehouse Listing</li>
				</ol>
			</div>
				...
				<div class="section">
					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="heading-block center">
							...
							<span>Listing of all warehouses by location.</span>
						</div>
...
<?php						$host        = "host = 127.0.0.1";
						...
						$sql =<<<EOF
						SELECT * FROM warehouse w INNER JOIN address a ON w.Address_ID = a.Address_ID ORDER BY a.City_Name;
EOF;
						$ret = pg_query($db, $sql);
						if(!$ret) {
