		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<!-- icon-crop, icon-tint, icon-text-width, icon-ok, icon-thumbs-up, icon-eye -->
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="suppliers.php"><i class="icon-truck-loading i-alt"></i></a>
							</div>
							<h3>Suppliers<span class="subtitle">Manage Suppliers</span></h3>
						</div>
					</div>
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="ware.php"><i class="icon-truck-moving i-alt"></i></a>
							</div>
							<h3>Warehouses<span class="subtitle">Warehouse Listing</span></h3>
						</div>
					</div>
					...
					<div class="col_one_third col_last">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="purchOrder.php"><i class="icon-list-alt2 i-alt"></i></a>
							</div>
							<h3>Purchase Orders<span class="subtitle">Purchase Order History</span></h3>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="section">
					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="heading-block center">
							...
							<span>Purchase orders pending delivery.</span>
						</div>
